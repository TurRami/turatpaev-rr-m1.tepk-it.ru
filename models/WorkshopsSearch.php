...
class WorkshopsSearch extends Workshops
{
    ...
    {
        return [
            [['id_workshops', 'workshops_type_id', 'count_people_production'], 'integer'],
            [['name'], 'safe'],
        ];
    }
    ...
    public function search($params, $formName = null)
    {
        ...
        $query->andFilterWhere([
            ...
            'workshops_type_id' => $this->workshops_type_id,
            'count_people_production' => $this->count_people_production,
        ]);
